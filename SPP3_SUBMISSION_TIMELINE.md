...
| Step | Dates | Notes |
|------|-------|-------|
| Artifacts published (this post) | May 14 | Rubric, application format, timeline |
| Service agreement published | May 19 | Published when submission window opens |
...
**1. Administrative Fields (fixed selectors)**
- Team / Organization Name
- Primary Contact
- ENS handle for payment address
- Email
- Telegram
- Team Status (New / SPP1/2 returning / Prior ENS work or grantee)
- Requested Amount (USD)
- Category (Infrastructure / Outreach and Integrations / DAO Infrastructure / General Ecosystem Benefit)
- Attestation that applicant has read the Program Terms and Award Notice

**2. Application Document**

The form accepts raw markdown, a URL to a document, PDF, markdown file, or Notion page. This is the main body of the application.
...
- Which category or categories does this work map to?
- If claiming Category 4, provide justification

**Scope** (included in submitted document)
...
**Milestones** (included in submitted document)
...
**Prior Delivery Record** (included in submitted document)
...
**Budget** (included in submitted document)
- Total requested amount (minimum $200,000)
- Breakdown by line item
- Brief justification for each major cost

**Rationale** (included in submitted document)
- Why should SPP3 fund this work?
- How does this work address the program objectives?

---

## Application Follow-up

The committee will schedule calls with qualified applicants. Applicants will be required to monitor their Telegram and emails for outreach from the committee for scheduling.

A call is not required to be evaluated, but it is encouraged to allow:
- The opportunity for the committee to ask clarifying questions synchronously
- The applicant to highlight any items in their proposal

This step will be the most likely area for bottleneck in the application review process. The committee will attend with at least two members (inclusive of the Chair), and record a transcript to share with members who could not attend.
...
Applications that pass the eligibility screen are scored by the committee on four criteria. Scores run from 1 to 5 in 0.5 increments. Weighted scores sum to a final score out of 5.0. Committee members rank individually and a composite score is computed across the four members.
...
The ENS DAO Service Provider [Program Terms](https://github.com/coltron-code/spp3-docs/blob/main/ENS_DAO_Service_Provider_Program_Terms_v1-0.pdf) (Version 1.0, 14 May 2026) governs all funded providers. By submitting an application, applicants acknowledge they have read the Program Terms and agree to be bound by them if selected. The Program Terms are not subject to negotiation or modification following submission.

The [Award Notice](https://github.com/coltron-code/spp3-docs/blob/main/ENS_DAO_Service_Provider_Program_Award_Notice_v1-0.pdf), a short recipient-specific document covering identity, project scope, fees, and term, will be issued by the ENS Foundation to each selected provider before funding begins. The application form includes a mandatory acknowledgement block that applicants must affirm before submitting.

---

## Budget

The SPP3 budget cap is approximately $3.4M as ratified in the program authorization proposal. After committee compensation ($150,000), approximately $3.25M is available for service provider funding. All funded providers are paid via stream from the accountability body's multisig. Unspent funds return to the DAO treasury at cycle close. The committee cannot expand this budget and is not required to exhaust all available funding in the cohort recommendation.

---

## Questions

Questions about the process or application format can be posted in the ENS Forum discussion thread. The committee will not discuss SPP3 with applicants outside of the structured interview process or publicly held calls once the submission window opens.
