...
Term aligns with the SPP3 funding cycle (12 months).
...
A committee Member or Chair may not:
...
- **Award sizing:** The committee may negotiate to fund providers at amounts smaller than requested, with rationale, and may negotiate scope or milestone adjustments.
...
*The timeline posted in this proposal may be adjusted by the committee if a change reasonably improves the process. Example cases may be to allow more time for submissions and review, or shortening a window if a step is completed early (rubric/review). Changes will be communicated on the forum.*
